...
class BiologyChemicalSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $chemicals = [
            ...
            // Basic chemicals needed for biology
            [
                'chemical_name' => 'Sodium Chloride',
                'category_code' => 'SALT',
                'unit' => 'kg',
                'hazard_classification' => 'Non-Hazardous',
                'storage_location' => 'General Chemical Shelf B-09',
            ],
            [
                ...
                'storage_location' => 'Flammable Cabinet B-01',
            ],
            [
                ...
                'storage_location' => 'Chemical Cabinet B-01',
            ],
            [
                ...
                'unit' => 'L',
                'hazard_classification' => 'Irritant',
                'storage_location' => 'Reagent Cabinet B-01',
            ],
            [
                'chemical_name' => 'Buffer Solution pH 7',
                'category_code' => 'REAGENT',
                'unit' => 'L',
                'hazard_classification' => 'Non-Hazardous',
                'storage_location' => 'Reagent Cabinet B-02',
            ],
            [
                'chemical_name' => 'Iodine Solution',
                'category_code' => 'REAGENT',
                'unit' => 'L',
                'hazard_classification' => 'Irritant',
                'storage_location' => 'Reagent Cabinet B-03',
            ],
            [
                'chemical_name' => 'Biuret Reagent',
                'category_code' => 'REAGENT',
                'unit' => 'L',
                'hazard_classification' => 'Irritant',
                'storage_location' => 'Reagent Cabinet B-04',
            ],
            [
                'chemical_name' => 'Sudan III',
                'category_code' => 'INDICATOR',
                'unit' => 'g',
                'hazard_classification' => 'Irritant',
                'storage_location' => 'Reagent Cabinet B-05',
            ],
        ];

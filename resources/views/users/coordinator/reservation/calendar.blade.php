...
@section('page-subtitle', 'View coordinator-approved laboratory reservations in month, week, and day layouts')
...
@section('content')
    <div class="reservation-calendar-page">
        ...
        <section class="card admin-card border-0 reservation-calendar-shell" data-reservation-calendar-shell>

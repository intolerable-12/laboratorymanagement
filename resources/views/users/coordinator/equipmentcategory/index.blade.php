...
@section('page-subtitle', 'Organize equipment into reusable categories')
        ...
        <div class="row g-4 align-items-center">
            <div class="col-lg-8">
                ...
                <div class="d-flex align-items-center gap-3 mb-3">
                    ...
                    <div>
                        <h2 class="display-6 fw-semibold text-dark mb-2">Create a clear category structure for every asset.</h2>
                        <p class="lead text-secondary mb-0" style="max-width: 58rem;">Use categories to keep equipment records organized across laboratories and reports.</p>
                    </div>
                </div>
            </div>
        ...
        <div class="card-header bg-white border-0 pt-4 px-4 px-xl-5">
            <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-3">
                <div>
                    ...
                    <p class="mb-0 text-secondary">Review equipment groups and jump into the record you need.</p>
                </div>

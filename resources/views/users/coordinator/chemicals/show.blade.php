    ...
    <div class="hero-banner equipment-hero rounded-4 p-4 p-lg-5 mb-4">
        <div class="row g-4 align-items-center">
            <div class="col-lg-8">
                ...
                <div class="d-flex align-items-center gap-3 mb-3">
                    <div class="equipment-hero__accent">
                        <span class="h4 mb-0 fw-semibold">{{ strtoupper(substr($chemical->chemical_name, 0, 1)) }}</span>
                    </div>
                    <div>
            ...
            <div class="col-lg-4 d-flex justify-content-lg-end gap-2 flex-wrap">
                ...
                <a href="{{ route('coordinator.chemicals.index') }}" class="btn btn-outline-secondary px-4">Back to list</a>
            </div>
        </div>
    </div>
            ...
            <div class="section-card h-100">
                <div class="card-body p-4 p-xl-5">
                    ...
                    <div class="barcode-panel mb-4">
                        ...
                        <div class="barcode-code">{{ $chemical->barcode }}</div>
                    </div>
            ...
            <div class="section-card h-100">
                <div class="card-body p-4 p-xl-5">
                    <div class="row g-4">
                        ...
                        <div class="col-md-6">
                            <div class="small text-uppercase text-secondary mb-1">CAS number</div>
                            <div class="fw-semibold text-dark">{{ $chemical->cas_number ?? '—' }}</div>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="fw-semibold text-dark">{{ $chemical->unit_cost ? '₱' . number_format((float) $chemical->unit_cost, 2) : '—' }}</div>
                        </div>
                        <div class="col-md-6">

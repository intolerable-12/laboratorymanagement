...
@section('nav-links')
    <div class="role-nav nav nav-pills flex-nowrap overflow-auto gap-2 pb-1">
        ...
        <a class="nav-link active" href="{{ route('student.myaccount') }}">My Account</a>
    </div>
@endsection
                ...
                <div class="card section-card border-0 h-100">
                    <div class="card-body p-4 p-xl-5">
                        ...
                        <div class="vstack gap-2">
                            @foreach ([
                                ['label' => 'Full Name', 'value' => 'Jane Doe Cruz'],
                                ['label' => 'Role', 'value' => 'Student'],
                                ['label' => 'Email Address', 'value' => 'student@lccdo.edu.ph'],
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-4">
                        <div class="account-summary-card">
                            ...
                            <div class="fw-semibold text-dark">August 2024</div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="account-summary-card">

...
@section('content')
    <div class="account-page inventory-page">
        <div class="d-flex flex-wrap justify-content-between align-items-center gap-2 mb-4">
            @include('users.student.inventory.partials.view-switcher', ['active' => 'equipment'])
        </div>
            ...
            <div class="card-body p-3 p-xl-4">
                <form method="GET" action="{{ route('student.inventory.equipment.index') }}" class="row g-3 align-items-end" data-live-search-form="student-equipment-categories">
                    ...
                    <div class="col-12 col-lg-auto d-flex gap-2">
                        ...
                        <a href="{{ route('student.inventory.equipment.index') }}" class="btn btn-outline-secondary px-4">Clear</a>
                    </div>
                </form>
            </div>
        </div>
                                    ...
                                    <tr>
                                        <td class="ps-4">
                                            <div class="d-flex align-items-center gap-3">
                                                ...
                                                <div>
                                                    <a href="{{ route('student.inventory.equipment.categories.show', $category) }}" class="fw-semibold text-dark text-decoration-none">{{ $category->category_name }}</a>
                                        ...
                                        <td class="text-center pe-4">
                                            <a href="{{ route('student.inventory.equipment.categories.show', $category) }}" class="btn btn-sm btn-outline-primary"><i class="fa-solid fa-eye me-1" aria-hidden="true"></i></a>
                                        </td>
                                    </tr>
                                @empty

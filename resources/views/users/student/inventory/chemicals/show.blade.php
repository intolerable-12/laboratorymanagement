...
@section('content')
    <div class="inventory-page">
        <div class="d-flex justify-content-between align-items-center gap-3 mb-4">
            <a href="{{ route('student.inventory.chemicals.categories.show', $chemical->category) }}" class="inventory-back-link">
        ...
        <section class="row g-0 inventory-detail-hero">
            ...
            <div class="col-lg-7 p-4 p-xl-5 inventory-detail-panel">
                ...
                <p class="text-secondary mb-4">
                    {{ $chemical->description ?: 'A concise student-facing summary of the chemical item and the fields you need to see at a glance.' }}
                </p>

<div data-reservation-tab-content="chemical">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <p class="mb-0 text-secondary">Use decimal quantities when necessary and keep the laboratory consistent with your reservation.</p>
        </div>
    ...
    <div class="d-flex justify-content-between align-items-center gap-3 mt-3 flex-wrap" data-reservation-pagination>
        ...
        <div>
            {{ $chemicalItems->appends(['tab' => 'chemical', 'fragment' => 'chemical', 'laboratory_id' => $selectedLaboratoryId])->links('pagination::bootstrap-5') }}
        </div>
    </div>
    @else
        <div class="alert alert-light border rounded-4 mb-0">
            Select a laboratory to view its available chemicals.
        </div>
    @endif
</div>
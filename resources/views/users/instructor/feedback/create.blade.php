            ...
            <div class="col-xl-8">
                <div class="card social-card border-0">
                    <div class="card-body p-4 p-xl-5">
                        <form method="POST" action="{{ route('instructor.feedback.store') }}" class="vstack gap-4">
                            @csrf
                            ...
                            <div class="d-flex flex-column flex-sm-row justify-content-end gap-2">
                                <a href="{{ route('instructor.feedback.index') }}" class="btn btn-outline-secondary px-4 rounded-pill">Cancel</a>

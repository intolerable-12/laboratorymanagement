...
@section('nav-links')
    @include('users.instructor.partials.nav-links', ['active' => null])
@endsection
    ...
    <div class="account-page">
        <div class="section-card mb-4">
            <div class="card-body p-4 p-xl-5 d-flex flex-column flex-lg-row align-items-lg-center justify-content-between gap-4">
                <div class="hero-copy">
                    <div class="social-eyebrow mb-3">Instructor feedback</div>
                ...
                <div class="d-flex flex-wrap gap-2">
                    ...
                    <a href="{{ route('instructor.feedback.create') }}" class="btn btn-primary px-4 rounded-pill">New feedback</a>
                </div>
            </div>
        </div>
        ...
        <div class="section-card mb-4" id="questionnaireList">
            <div class="card-body p-4 p-xl-5">
                <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-3 mb-3">
                    ...
                    <a href="{{ route('instructor.feedback.questionnaires.index') }}" class="btn btn-outline-secondary rounded-pill px-4">
                            ...
                            @forelse ($questionnaires as $questionnaire)
                                <tr>
                                    ...
                                    <td class="text-center pe-3">
                                        <a href="{{ route('instructor.feedback.questionnaires.show', $questionnaire) }}" class="btn btn-sm btn-outline-primary">

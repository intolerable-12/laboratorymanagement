    ...
    <div class="account-page">
        ...
        <div class="questionnaire-hero-card section-card mb-3">
            <div class="questionnaire-hero-content">
                ...
                <a href="{{ route('instructor.feedback.index') }}" class="btn btn-sm btn-outline-secondary px-3 rounded-pill">
            ...
            <div class="col-12">
                <div class="section-card questionnaire-card mb-3">
                    ...
                    @if ($response)
                        ...
                        @endif
                    @else
                        <form method="POST" action="{{ route('instructor.feedback.questionnaires.store', $feedbackQuestionnaire) }}" data-required-indicators="manual">
                            @csrf
                            ...
                            <div class="card-footer bg-white p-3 d-flex justify-content-end gap-2 border-top">
                                <a href="{{ route('instructor.feedback.questionnaires.index') }}" class="btn btn-sm btn-outline-secondary px-3 rounded-pill">Cancel</a>

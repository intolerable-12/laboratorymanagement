...
@section('page-title', 'Reservation Calendar')
@section('user-name', 'Instructor')
@section('user-role', 'Instructor')

@section('nav-links')
    @include('users.instructor.partials.nav-links', ['active' => 'reservation-calendar'])
@endsection
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        <div class="account-summary-card h-100">
                                            ...
                                            <div class="small text-secondary"><span data-reservation-school-year>-</span> | <span data-reservation-semester>-</span></div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table align-middle mb-0">
                                            ...
                                            <tbody data-reservation-items-body>
                                                <tr><td colspan="5" class="text-center text-secondary py-4">Select a reservation on the calendar.</td></tr>
                                            </tbody>
                                        </table>
                                    </div>
                                </div>

...
@php
    ...
    $sortUrl = function (string $column) use ($chemicalCategory, $sortQuery, $currentSort, $currentDirection) {
        ...
        return route('instructor.inventory.chemicals.categories.show', array_merge([
    ...
    <div class="inventory-page">
        ...
        <section class="inventory-filter-card card border-0 mb-4">
            <div class="card-body p-4">
                <form method="GET" action="{{ route('instructor.inventory.chemicals.categories.show', $chemicalCategory) }}" class="row g-3 align-items-end" data-live-search-form="instructor-chemical-items">
                    ...
                    <div class="col-12 col-md-4 col-lg-3 d-flex gap-2">
                        ...
                        <a href="{{ route('instructor.inventory.chemicals.categories.show', $chemicalCategory) }}" class="btn btn-outline-secondary">Clear</a>
                    </div>
                                        ...
                                        <div class="inventory-table__identity">
                                            ...
                                            <div>
                                                <div class="inventory-table__name">
                                                    <a href="{{ route('instructor.inventory.chemicals.show', $chemical) }}">{{ $chemical->chemical_name }}</a>
                                                </div>

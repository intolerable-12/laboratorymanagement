    ...
    <div class="account-page inventory-page">
        ...
        <section class="inventory-filter-card card border-0 mb-4">
            <div class="card-body p-4">
                <form method="GET"
                    action="{{ route('instructor.inventory.equipment.index') }}"
                    class="row g-3 align-items-end"
                    data-live-search-form="instructor-equipment-categories">

                    <div class="col-12 col-md-8 col-lg-9">
                        <label for="equipment-category-search" class="form-label fw-semibold text-dark">
                            Search categories
                        </label>
                    ...
                    <div class="col-12 col-md-4 col-lg-3 d-flex gap-2">
                        ...
                        <a href="{{ route('instructor.inventory.equipment.index') }}"

...
<div class="role-nav nav nav-pills flex-nowrap overflow-auto gap-2 pb-1">
    ...
    <a class="nav-link {{ $activeLink === 'reservation-calendar' ? 'active' : '' }}" href="{{ route('instructor.reservations.calendar') }}">Reservation Calendar</a>
    <a class="nav-link {{ $activeLink === 'borrow' ? 'active' : '' }}" href="{{ route('instructor.borrow.index') }}">Borrow</a>
    <a class="nav-link {{ $activeLink === 'borrow-calendar' ? 'active' : '' }}" href="{{ route('instructor.borrow.calendar') }}">Borrow Calendar</a>
    <a class="nav-link {{ $activeLink === 'forum' ? 'active' : '' }}" href="{{ route('instructor.forum.index') }}">Forum</a>
    <a class="nav-link {{ $activeLink === 'inventory' ? 'active' : '' }}" href="{{ route('instructor.inventory.index') }}">Inventory</a>

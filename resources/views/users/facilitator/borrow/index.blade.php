...
@php
    ...
    $sortUrl = function (string $column) use ($sortQuery, $currentSort, $currentDirection) {
        ...
        return route('facilitator.borrow.index', array_merge($sortQuery, [
            'sort' => $column,
        ...
        <section class="hero-banner card border-0 mb-4">
            <div class="card-body p-4 p-xl-5 d-flex flex-column flex-lg-row align-items-lg-center justify-content-between gap-3">
                <div>
                    ...
                    <p class="mb-0 text-secondary">Review all borrow requests and verify availability before deciding.</p>
                </div>
            </div>
        </section>
                            ...
                            @forelse ($borrows as $borrow)
                                ...
                                <tr>
                                    ...
                                    <td class="text-center pe-4">
										<a href="{{ route('facilitator.borrow.show', $borrow) }}" class="btn btn-sm btn-outline-primary"><i class="fa-solid fa-eye me-1" aria-hidden="true"></i></a>
									</td>
                                </tr>
                            @empty
                                <tr>

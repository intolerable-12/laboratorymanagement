...
@section('nav-links')
    <div class="role-nav nav nav-pills flex-nowrap overflow-auto gap-2 pb-1">
        <a class="nav-link" href="{{ route('facilitator.dashboard') }}">Dashboard</a>
        <a class="nav-link" href="#">Inventory</a>
        <a class="nav-link" href="#">Barcode Scanner</a>
        <a class="nav-link" href="#">Activity Log</a>
        <a class="nav-link" href="#">Report Logs</a>
        <a class="nav-link active" href="{{ route('facilitator.myaccount') }}">My Account</a>
    </div>
@endsection
                    ...
                    <div class="card-body p-4 p-xl-5">
                        ...
                        <div class="vstack gap-2">
                            @foreach ([
                                ...
                                ['label' => 'Email Address', 'value' => 'facilitator@lccdo.edu.ph'],
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-4">
                        <div class="account-summary-card">
                            ...
                            <div class="fw-semibold text-dark">May 2024</div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="account-summary-card">

                ...
                @if (! $forumPost->is_locked)
                    <div class="card social-card border-0 mb-4">
                        <div class="card-body p-4 p-xl-5">
                            ...
                            <form method="POST" action="{{ route('facilitator.forum.comments.store', $forumPost) }}" class="vstack gap-3">
                                @csrf
                ...
                <div class="card social-card border-0">
                    <div class="card-body p-4 p-xl-5">
                        ...
                        @forelse ($commentTree as $comment)
                            @include('users.facilitator.forum.partials.comment', ['comment' => $comment, 'forumPost' => $forumPost, 'level' => 0])
                        @empty

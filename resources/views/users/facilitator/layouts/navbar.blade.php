<nav class="navbar navbar-expand-lg navbar-light admin-navbar sticky-top px-3 px-lg-4 py-3">
    <div class="container-fluid px-0">
        @php
            ...
            $displayName = $displayName !== '' ? $displayName : 'Laboratory In-charge';
            $displayRole = $user?->role?->role_name
                ? $user->role->role_name . ' account'
                : 'Laboratory In-charge account';
        @endphp
        ...
        <div class="d-flex align-items-center gap-3">
            ...
            <h1 class="h5 mb-0 fw-semibold text-dark">@yield('page-title', $__env->yieldContent('title', 'Dashboard'))</h1>
        </div>
        ...
        <div class="ms-auto d-flex align-items-center gap-3">
            ...
            <div class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end shadow-sm">
                    ...
                    <li><a class="dropdown-item" href="{{ route('facilitator.myaccount') }}">My Account</a></li>

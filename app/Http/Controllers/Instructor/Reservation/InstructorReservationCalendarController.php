...
class InstructorReservationCalendarController extends Controller
{
    public function index(Request $request): View
    {
        ...
        return view('users.instructor.reservation.calendar', [
            'calendarStats' => [
    ...
    private function toCalendarEvent(Reservation $reservation): array
    {
        ...
        $color = $this->statusColor($reservation->status);

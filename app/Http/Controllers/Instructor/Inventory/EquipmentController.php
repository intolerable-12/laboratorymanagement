...
class EquipmentController extends Controller
{
    public function index(): View
    {
        ...
        return view('users.instructor.inventory.equipment.index', compact('categories', 'stats', 'featuredImages'));
    }
    ...
    public function category(EquipmentCategory $equipmentCategory): View
    {
        ...
        return view('users.instructor.inventory.equipment.category', compact('equipmentCategory', 'equipmentItems'));
    }

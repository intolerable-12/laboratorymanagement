...
class ChemicalController extends Controller
{
    public function index(): View
    {
        ...
        return view('users.instructor.inventory.chemicals.index', compact('categories', 'stats', 'featuredImages'));
    }
    ...
    public function category(ChemicalCategory $chemicalCategory): View
    {
        ...
        return view('users.instructor.inventory.chemicals.category', compact('chemicalCategory', 'chemicals'));
    }

...
class ChemicalController extends Controller
{
    public function index(Request $request): View
    {
        ...
        return view('users.instructor.inventory.chemicals.index', compact('categories', 'stats', 'featuredImages', 'search', 'sort', 'direction'));
    }
    ...
    public function category(Request $request, ChemicalCategory $chemicalCategory): View
    {
        ...
        return view('users.instructor.inventory.chemicals.category', compact('chemicalCategory', 'chemicals', 'search', 'sort', 'direction'));
    }
    ...
    public function show(Chemical $chemical): View
    {
        ...
        return view('users.instructor.inventory.chemicals.show', compact('chemical'));
    }
}

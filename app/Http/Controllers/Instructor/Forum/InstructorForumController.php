...
namespace App\Http\Controllers\Instructor\Forum;
...
class InstructorForumController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('users.instructor.forum.index', compact('forumPosts', 'search', 'category', 'categories'));
    }
    ...
    public function create(Request $request)
    {
        ...
        return view('users.instructor.forum.create', [
            'categories' => ForumPost::categories(),
        ]);
    }

...
namespace App\Http\Controllers\Instructor\Account;
...
class MyAccountController extends Controller
{
	public function index(Request $request): View
	{
		...
		return view('users.instructor.myaccount', $this->accountViewData($user));
	}
	...
	private function accountViewData(User $user): array
	{
		return [
			...
			'roleName' => $user->role?->role_name ?? 'Instructor',
			'email' => $user->email,
	...
	private function displayName(User $user): string
	{
		...
		return $name !== '' ? $name : ($user->userID ?? 'Instructor');
	}
